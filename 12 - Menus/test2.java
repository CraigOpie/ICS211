/**
 * <h1>Menus</h1>
 * This class demonstrates in depth understanding of creating a JavaFX GUI menu item.
 *
 * @author  Craig Opie
 * @version 1.0, 11/02/19
 * @class   Menus
 * @concept The core concept for this lesson is the ability to a menu using JavaFX.
 *
 */
...
public class Menus extends Application {
    ...
    public void start(Stage stage) {
        ...
        VBox layout = VBoxBuilder.create().spacing(0).children(menuBar, text_).build();
